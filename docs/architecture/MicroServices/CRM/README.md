...
The CRM Microservice manages all customer relationship operations within the
system. It handles contact and company management, deal pipelines, activities,
tasks, notes, and reporting.
